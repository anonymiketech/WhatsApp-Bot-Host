...
import { useStartBot, useStopBot, useRestartBot, useRenewBot } from "@/hooks/use-bots";
import {
  Play, Square, RotateCcw, Loader2, Clock, Coins, Cpu,
  AlertTriangle, RefreshCw, CheckCircle2, Server,
} from "lucide-react";
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {/* Pterodactyl badge */}
        {hasPtero && (
          <div className="flex items-center gap-1 px-2 py-1 rounded-lg bg-secondary/60 border border-white/5 flex-shrink-0">
